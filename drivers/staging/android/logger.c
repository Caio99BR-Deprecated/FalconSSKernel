...
DEFINE_LOGGER_DEVICE(log_system, LOGGER_LOG_SYSTEM, CONFIG_LOGCAT_SIZE*2*1024)
DEFINE_LOGGER_DEVICE(log_kernel, LOGGER_LOG_KERNEL, CONFIG_LOGCAT_SIZE*2*1024)
DEFINE_LOGGER_DEVICE(log_kernel_bottom, LOGGER_LOG_KERNEL_BOT, CONFIG_LOGCAT_SIZE*2*1024)
